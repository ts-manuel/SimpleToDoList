...
## Requirements
This project uses .NET Core 9.0 https://dotnet.microsoft.com/en-us/download
...
dotnet new avalonia.mvvm -o src/SimpleToDoList

# Install xUnit templates
dotnet new install xunit.v3.templates

# Create new xUnit project
dotnet new xunit3 --language C# -f net9.0 -o tests/SimpleToDoListTests -n SimpleToDoListTests
```
